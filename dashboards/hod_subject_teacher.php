...
<?php include("../includes/hod-header.php") ?>
        ...
        <div class="col-md-12 mt-5">
            <div class="card ">
                <div class="card-header d-flex justify-content-between bg-dark text-light">
                    ...
                    <a href="hod_subject_teacher_add.php" class="btn btn-primary">Add Subject Teacher</a>
                </div>
                <div class="card-body">
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="hod_subject_teacher_edit.php?subject_teacher_id=<?php echo $row['Subject_Teacher_Id'] ?>" class="btn btn-primary edit me-2">Edit</a>
                                        </td>
                                        <td class="text-center">
