...
if (isset($_POST['time_table_add_btn'])) {
    ...
    if ($result) {
        ...
        header('Location: ../dashboards/ttm_timetable_details.php'); // Redirect to a success page or details page
    } else {
        $_SESSION['status'] = "Error: " . mysqli_error($conn);
        $_SESSION['status_code'] = "error";
        header('Location: ../dashboards/ttm_timetable_add.php'); // Redirect back to the form in case of error
    }
    exit();
}
...
if (isset($_POST['delete_btn_set'])) {
    ...
    if ($result) {
        ...
        $_SESSION['status_code'] = "success";
        header('Location: ../dashboards/ttm_timetable_details.php');
    } else {
