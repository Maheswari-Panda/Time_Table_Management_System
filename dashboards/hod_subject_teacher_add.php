<?php include("hod_subject_teacher_code.php")?>
    ...
    <div class="row">
        <div class="col-md-12 mt-5">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="hod_subject_teacher_code.php">
                        ...
                        <!-- Submit Button -->
                        <div class="mb-3">
                            <a href="hod_subject_teacher.php" class="btn btn-danger">Cancel</a>
