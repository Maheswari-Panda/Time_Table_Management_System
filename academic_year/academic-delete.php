...
<script>
     $(document).ready(function (){
        ...
        $(document).on('click', '.academic-delete-btn', function (e) {
          e.preventDefault();
          ...
          swal({
              title: "Are you sure?",
              text: "Once deleted, you will not be able to recover this Academic Year of Faculty",
              icon: "warning",
              buttons: true,
              dangerMode: true,
            })
            .then((willDelete) => {
              if (willDelete) {
                  $.ajax({
                    type: "POST",
                    url: "academic-code.php",
                    data:{
                      "delete_btn_set":1,
                      "delete_id": delete_id,
                    },
                    success: function (responses){
                      swal("Academic Year Deleted Successfully!", {
                        icon: "success",
                      })
                      .then((result) => {
